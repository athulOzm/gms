        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column m-b-5 float_right">
                    <?php if ($this->permission1->check_label('returns')->create()->access()) { ?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <?php echo display('supplier_return_list'); ?>
                                ...
                                <tbody>
                                    ...
                                    if ($return_list) {
                                        ...
                                        <tr>
                                            ...
                                            <td>{final_date}</td>
                                            <td class="float_right"><?php echo (($position == 0) ? "$currency {net_total_amount}" : "{net_total_amount} $currency") ?></td>
                                            <td>
                                    <center>
                                        <?php echo form_open(); ?>
                                        ...
                                        <?php } if ($this->permission1->check_label('supplier_return_list')->delete()->access()) { ?>
