...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('edit_courtesy_booking') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('calender') ?></a></li>
                <li class="active"><?php echo display('edit_courtesy_booking') ?></li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('edit_courtesy_booking') ?> </h4>
                        </div>
                    </div>

                    <div class="panel-body">
                        <?php echo form_open('Ccalender/update_courtesy_booking', array('class' => 'form-vertical', 'id' => '')) ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="vehicle_reg" id="registration_no" class="form-control" required="">
                                    <?php foreach ($vehicles as $vehicle) { ?>
                                        <option value="<?php echo $vehicle['vehicle_registration'] ?>" <?php
                                        if ($booking[0]['vehicle_reg'] == $vehicle['vehicle_registration']) {
                                            echo 'selected';
                                        }
                                        ?>><?php echo $vehicle['vehicle_registration'] ?></option>
                                            <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control datepicker" name ="start_date" id="start_date" type="text" placeholder="<?php echo display('start_date') ?>" required value="<?php echo $booking[0]['start_date'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control datepicker" name ="end_date" id="end_date" type="text" placeholder="<?php echo display('end_date') ?>" onchange="booking_vehicle(this.value)" required value="<?php echo $booking[0]['end_date'] ?>">
                            </div>
