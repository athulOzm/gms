                                ...
                                <tr class="table_data">
                                    ...
                                    if ($oResultTrial->Debit > $oResultTrial->Credit) {
                                        ...
                                        <td  align="right" bgcolor="<?php echo $bg; ?>" style="border-left: solid 1px #000; border-top: solid 1px #000;"><?php
                                            ...
                                            ?></td>
                                        <td  align="right" bgcolor="<?php echo $bg; ?>" style="border-left: solid 1px #000; border-right: solid 1px #000; border-top: solid 1px #000;"><?php echo number_format('0.00', 2); ?></td>
                                        <?php
                                    } else {
                                        ?>
                                        <td  align="right" bgcolor="<?php echo $bg; ?>" style="border-left: solid 1px #000; border-top: solid 1px #000;"><?php
