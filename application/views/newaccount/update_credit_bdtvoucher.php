                            ...
                            <div class="col-sm-4">
                                <select name="cmbDebit" id="cmbDebit" class="form-control">
                                    ...
                                    <?php foreach ($crcc as $cracc) { ?>
                                        <option value="<?php echo $cracc->HeadCode ?>" <?php
                                        if ($debit_info->COAID == $cracc->HeadCode) {
                                            echo 'selected';
                                        }
                                ...
                                <tbody id="debitvoucher">
                                    ...
                                    foreach ($crvoucher_info as $upcrvoucher) {
                                        ...
                                        <tr>
                                            <td class="w-200">  
                                                <select name="cmbCode[]" id="cmbCode_<?php echo $sl; ?>" class="form-control" onchange="load_code(this.value,<?php echo $sl; ?>)">
                                                    <?php foreach ($acc as $acc1) { ?>
                                                        ...
                                                        if ($upcrvoucher->COAID == $acc1->HeadCode) {
                                                            echo 'selected';
                                                        }
                                            ...
                                            <td><input type="text" name="txtAmount[]" value="<?php echo $upcrvoucher->Credit ?>" class="form-control text-right total_price"  id="txtAmount_<?php echo $sl; ?>" onkeyup="calculation(<?php echo $sl; ?>)" >
                                            </td>
                                            <td class="text-center">
                                                <button  class="btn btn-danger red" type="button" value="<?php echo display('delete') ?>" onclick="deleteRow(this)"><i class="fa fa-trash-o"></i></button>
                                            </td>
                                        </tr>                              
                                        <?php
                                        $sl++;
