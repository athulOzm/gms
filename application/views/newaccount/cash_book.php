...
//                                                  </a>&nbsp;";
                                                            ...
                                                            <td align="justify" bgcolor="<?php echo $bg; ?>"><?php echo $oResult->rows[$i]['Vtype'];
                                                                ?>
                                                                <!--                                            <div id="HidePODetail">--><?php
                                                                //echo $oResult->rows[$i]['Narration'];
//                                                
                                                                ?>
                                                                <!--                                            </div>-->
                                                        ...
                                                        <td align="right" bgcolor="<?php echo $bg; ?>"><?php
                                                            ...
                                                            echo number_format($oResult->rows[$i]['Credit'], 2, '.', ',');
                                                            ?></td>
                                                        <td  align="right" bgcolor="<?php echo $bg; ?>"><?php
                                                            $TotalCredit += $oResult->rows[$i]['Debit'];
                                                            $PreBalance -= $oResult->rows[$i]['Debit'];
                                                            echo number_format($oResult->rows[$i]['Debit'], 2, '.', ',');
                                                            ?></td>
                                                ...
                                                ?>
                                                <tr class="table_data text-white bg-green ">
                                                    <td class="text-white bg-green">&nbsp;</td>
                                                    <td align="center">&nbsp;</td>
                                                    <td align="center">&nbsp;</td>
                                                    <td align="center">&nbsp;</td>
                                                ...
                                                <div class="text-center m-20" id="print">
                                                    <input type="button" class="btn btn-warning" name="btnPrint" id="btnPrint" value="Print" onclick="printDiv('printableArea')"/>
                                                </div>
                                                </div>
