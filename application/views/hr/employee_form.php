                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="phone" class="form-control" type="text" onkeyup="onlynumber_allow(this.value, 'phone')" placeholder="<?php echo display('phone') ?>" id="phone">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="email" class="form-control" type="email" placeholder="<?php echo display('email') ?>" onkeyup="employee_email_to_username(this.value)" id="email" required>
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="user_name" class="col-sm-2 col-form-div"><?php echo display('user_name') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <input name="user_name" class="form-control" type="email" placeholder="<?php echo display('user_name') ?>" id="user_name" required>
                            </div>
                            <label for="password" class="col-sm-2 col-form-div"><?php echo display('password') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="role_id" id="role_id" required> 
                                    ...
                                    foreach ($get_rolelist as $data) {
                                        ?>
                                        <option value="<?php echo $data['id'] ?>" <?php if ($data['type'] == 'Mechanic Role') {
                                        echo 'selected';
