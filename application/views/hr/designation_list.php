...
//                                        dd($designation_list);
                                        ...
                                        <center>
                                            <?php echo form_open() ?>
                                            <?php if ($this->permission1->check_label('manage_designation')->update()->access()) { ?>                              
                                            ...
                                            <?php } ?>
                                            <?php if ($this->permission1->check_label('manage_designation')->delete()->access()) { ?>                                
                                                <a href="<?php echo base_url('Chrm/designation_delete/'.$designations['id']) ?>" class="DeleteDesignation btn btn-danger btn-sm" onclick="return confirm('Are You Sure,Want to Delete ?')" name="<?php echo $designations['id'] ?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                <?php } ?>
                                                <?php echo form_close() ?>
                                        </center>
                                        </td>
