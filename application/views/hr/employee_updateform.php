<link href="<?php echo base_url('assets/custom/hrm.css') ?>" rel="stylesheet" type="text/css"/>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" name="id" value="<?php echo $employee_data[0]['employee_row_id']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="phone" class="form-control" type="text" onkeyup="onlynumber_allow(this.value, 'phone')" placeholder="<?php echo display('phone') ?>" id="phone" value="<?php echo $employee_data[0]['phone'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="rate_type" class="form-control">
                                    ...
                                    <option value="1" <?php
                                    if ($employee_data[0]['rate_type'] == 1) {
                                        echo 'selected';
                                    }
                                    ?>><?php echo display('hourly') ?></option>
                                    <option value="2"  <?php
                                    if ($employee_data[0]['rate_type'] == 2) {
                                        echo 'selected';
                                    }
                        ...
                        <hr>
                        <div class="row">
                            <h3 class="bg-green login_ttl ">Login Info</h3>
                        </div>
                        <div class="form-group row">
                            <label for="user_name" class="col-sm-2 col-form-div"><?php echo display('user_name') ?></label>
                            <div class="col-sm-4">
                                <input name="user_name" class="form-control" type="text" value="<?php echo $employee_data[0]['username']; ?>" placeholder="<?php echo display('user_name') ?>" id="user_name" required>
                            </div>
                            <label for="password" class="col-sm-2 col-form-div"><?php echo display('password') ?></label>
                            <div class="col-sm-4">
                                <input name="password" class="form-control" type="password" placeholder="<?php echo display('password') ?>" id="password">
                                <input name="oldpassword" class="form-control" type="hidden" value="<?php echo $employee_data[0]['password']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">                            
                            <label for="role_id" class="col-sm-2 col-form-div"><?php echo display('role_name'); ?><span class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <select class="form-control" name="role_id" id="role_id" required> 
                                    ...
                                    foreach ($get_rolelist as $data) {
                                        ...
                                        if ($employee_data[0]['role_id'] == $data['id']) {
                                            echo 'selected';
                                        }
                        ...
                        <div class="form-group text-right">
                            <input type="hidden" name="employee_id" value="<?php echo $employee_data[0]['user_id']; ?>">
