                                ...
                                <tbody>
                                    ...
                                    if ($user_list) {
                                        ...
                                        <center>
                                            ...
                                            if ($user["user_type"] != 1) {
                                                ?>
                                                <a href="<?php echo base_url('User/user_delete/' . $user["user_id"]); ?>" class="deleteUser btn btn-danger btn-sm" name="<?php echo $user["user_id"] ?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> " onclick="return confirm('Are you sure')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                    <?php
                                                }
                                                ?>
                                                <?php echo form_close() ?>
