        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column m-b-5 float_right">
                    <?php if ($this->permission1->check_label('add_new_bank')->create()->access()) { ?>
                    ...
                    <?php } ?>
                    <?php if ($this->permission1->check_label('bank_transaction')->read()->access()) { ?>
                                ...
                                <tbody>
                                    ...
                                    if ($bank_list) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo form_open() ?>
                                                <?php if ($this->permission1->check_label('manage_bank')->update()->access()) { ?>
