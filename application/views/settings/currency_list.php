    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12 float_right">
                <?php //if ($this->permission->method('add_currency', 'create')->access()) { ?>
                <a href="<?php echo base_url('Currency/currency_form') ?>" class="btn btn-primary text-white"><?php echo display('add_currency') ?> </a>
                <?php //} ?>
            </div>
        </div>
        <!-- Account List -->
