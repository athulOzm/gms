...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('add_job_type') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('jobs') ?></a></li>
                <li class="active"><?php echo display('add_job_type') ?></li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column float_right">
                    <?php if ($this->permission1->check_label('manage_job_type')->delete()->access()) { ?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('add_job_type') ?> </h4>
                        </div>
                    </div>
                    <?php echo form_open('Cjob/insert_job_type', array('class' => 'form-vertical', 'id' => 'insert_job_type')) ?>
                    <div class="panel-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control select2" name="job_category_id" id="job_category_id" required>
                                    <option value=""></option>
                                    <?php
                                    foreach ($job_category as $single) {
                                        echo "<option value='$single->job_category_id'>$single->job_category_name</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="job_type_name" id="job_type_name" type="text" placeholder="<?php echo display('job_type_name') ?>"  required="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="job_type_rate" id="job_type_rate" type="text" placeholder="<?php echo display('job_type_rate') ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <!--<input type="text" class="form-control standard_timing" id="standard_timing" name="standard_timing">-->
                                <input id="standard_timing" type="text" class="form-control time" name="standard_timing"/>
                            </div>
                        </div>
                        <div class="form-group row">
