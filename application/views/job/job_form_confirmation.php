...
//                                            }
                            ...
                            <div class="tab-pane" id="tab2">                                
                                ...
                                <div class="row">                                    
                                    <h4 class="m-l-20"><?php echo display('job_performed'); ?></h4><hr>
                                    <?php if ($get_workorder[0]->status != 0) { ?>
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                            ...
                                            <table class="table table-bordered" id="item_table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php
                                                        //echo '1'.$get_employeelist[0]->user_id. 'xx'.$user_id;
                                                                ...
                                                                <td>
                                                                    ...
                                                                    foreach ($get_jobtypelist as $jobtype) {
                                                                        if ($job_details->job_type_id == $jobtype->job_type_id && $jobtype->fk_inspection_id != 0) {
                                                                            ?>
                                                                            <button type="button" class="btn btn-xs btn-info m-t-5" onclick="assign_checklist('<?php echo $jobtype->fk_inspection_id; ?>', '<?php echo $get_workorder[0]->job_id; ?>')" data-toggle='tooltip' data-placement='top' title='Assign Checklist'>
...
//                                                                            echo $checklist_view->job_type_id;
                                                                            ...
                                                                            if ($check_job_typeid_package) {
                                                                                ?>
                                                                                <button type="button" class="btn btn-xs btn-success m-t-5" onclick="view_checklist('<?php echo $jobtype->fk_inspection_id; ?>', '<?php echo $get_workorder[0]->job_id; ?>')" data-toggle='tooltip' data-placement='top' title='View Checklist'>
...
//                                                                    if ($job_details->status != 3 && $job_details->start_datetime == '0000-00-00 00:00:00') {
        ...
        <!--                                                                        <label for="declined_<?php echo $i; ?>">
                                                                    ...
                                                                    <select class="" name="checked_hdn_<?php echo$i; ?>" id="checked_hdn_<?php echo$i; ?>" onchange="declined_status('<?php echo $i; ?>', this.value)">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header text-center" >
                                                ...
                                                <img src="<?php echo $Web_settings[0]['logo']; ?>">
                                            </div>
                                ...
                                <div class="row">
                                    <h4 class="m-l-20"><?php echo display('product_used'); ?></h4>
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="product_table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class='text-right'><?php echo display('available_quantity'); ?></th>   
                                                        <th class='text-right'><?php echo display('used_quantity'); ?></th>   
...
//                                                           d($available_data);
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" name="available_qty[]" id="available_qty_<?php echo $i; ?>" class="form-control text-right" value="<?php $available_quantity = $CI->jobconfirm_editmode_quantitycheck($usedproduct->product_id); ?>" readonly>   
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="used_qty[]" value="<?php echo $usedproduct->used_qty; ?>" id="used_qty_<?php echo $i; ?>" class="form-control text-right" onchange="quantity_checked('<?php echo $i; ?>')" onkeyup="quantity_checked('<?php echo $i; ?>')">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="price[]" value="<?php echo $usedproduct->rate; ?>" class="form-control text-right" id="product_price_<?php echo $i; ?>" readonly>
                                                                </td>
                                                                <?php if ($user_type == 1 || $user_type == 2) { ?>
                                                                    <td>
...
?>\n\
    ...
    function addProduct(t) {
        ...
        var tr = document.createElement('tr');
        tr.innerHTML = '<td><select name="product_id[]" id="product_id_' + count + '"  class="form-control select2" onchange="product_data(this.value,' + count + ')"><option value="" >-- select one -- </option><?php foreach ($get_productlist as $product) { ?><option value="<?php echo $product->product_id; ?>"><?php echo $product->product_name; ?></option> <?php } ?><?php foreach ($get_groupprice as $groupprice) { ?><option value="<?php echo $groupprice->group_price_id; ?>"><?php echo $groupprice->group_name; ?></option><?php } ?></select></td>\n\
                                 <td><input type="text" name="available_qty[]" id="available_qty_' + count + '" class="form-control text-right" readonly> </td>\n\
                                <td><input type="text" name="used_qty[]" id="used_qty_' + count + '" class="form-control text-right" onchange="quantity_checked(' + count + ')" onkeyup="quantity_checked(' + count + ')"> </td>\n\
                                <td> <input type="text" name="price[]" class="form-control text-right" id="product_price_' + count + '" readonly> </td>\n\
<?php if ($user_type == 1 || $user_type == 2) { ?>\n\
...
//    ============== its for declined_status =============
    "use strict";
    function declined_status(sl, id) {
        var startdatetime = $("#startdatetime_" + sl).val();
        var enddatetime = $("#enddatetime_" + sl).val();
        if (id == 2) {
            $("#startdatetime_" + sl).val('');
            $("#enddatetime_" + sl).val('');
        } else {
            $("#startdatetime_" + sl).val(startdatetime);
            $("#enddatetime_" + sl).val(enddatetime);
        }
    }
</script>
