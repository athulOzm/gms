    ...
    <option value="<?php echo $single->vehicle_id; ?>" <?php
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="tex" name="schedule_datetime" id="schedule_datetime" class="form-control basic_example_3" value="<?php echo $get_workorder[0]->schedule_date_time; ?>" placeholder="<?php echo display('schedule_datetime') ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="tex" name="delivery_datetime" id="delivery_datetime" class="form-control basic_example_3" value="<?php echo $get_workorder[0]->delivery_date_time; ?>" placeholder="<?php echo display('delivery_datetime') ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php if ($user_type == 1 || $user_type == 2) { ?>
                                                            <th width="20%"><?php echo display('starting_datetime'); ?></th>    
                                                        <?php } ?>                                                            
                                                        <?php if ($user_type == 1 || $user_type == 2) { ?>
                                                            <th width="20%"><?php echo display('mechanic_notes'); ?></th>   
                                                        <?php } ?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    foreach ($get_jobtypelist as $jobtype) {
                                                                        if ($job_details->job_type_id == $jobtype->job_type_id && $jobtype->fk_inspection_id != 0) {
                                                                            ?>
                                                                            <button type="button" class="btn btn-sm btn-info" onclick="assign_checklist('<?php echo $jobtype->fk_inspection_id; ?>', '<?php echo $get_workorder[0]->job_id; ?>')" data-toggle='tooltip' data-placement='top' title='Assign Checklist'>
...
//        var spent_time = (startdatetime-enddatetime)/ (1000 * 60 * 60 * 24);
//        alert(spent_time);
        if (startdatetime == ' ') {
