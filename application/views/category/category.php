        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column m-b-5 float_right">
                    <?php if ($this->permission1->check_label('add_category')->create()->access()) { ?>
        ...
        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <center>
                                        <?php echo form_open() ?>
                                        <?php if ($this->permission1->check_label('manage_category')->update()->access()) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if ($this->permission1->check_label('manage_category')->delete()->access()) { ?>
            ...
            <div id="category_csv" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <input type="hidden" id="categoryDeleteURL" value="<?php echo base_url('Ccategory/category_delete') ?>">
                </div>
            </div>
        </div>
    </section>
...
<!-- Manage Category End -->
<script src="<?php echo base_url('assets/custom/category.js'); ?>"></script>
