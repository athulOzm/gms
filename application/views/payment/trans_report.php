                                                ...
                                                <tr>
                                                    <td  align="center">
                                                        <a href="" data-toggle="modal" data-target="#myModal" 
                                                           ...
                                                           onclick="javascript:report_popup(<?php echo $row['transection_category']; ?>)" ><?php
                                                               if ($row['transection_category'] == 1) {
                                                                   echo 'Supplier';
                                                               } elseif ($row['transection_category'] == 2) {
                                                                   echo 'Customer';
                                                               } elseif ($row['transection_category'] == 3) {
                                                                   echo 'Office';
                                                               } else {
                                                                   echo 'Loan';
                                                               }
