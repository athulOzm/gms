            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <a href="<?php echo base_url('Creport/stock_report_downloadpdf') ?>" class="btn btn-warning">Pdf</a> 
                        <?php echo form_close() ?>
                    </div>
                </div>
            </div>
                        ...
                        <div id="printableArea" class="table-responsive m-l-2">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table table-bordered table-striped table-hover">
                                    <caption><h3 class="text-center"><?php echo display('stock_report') ?></h3></caption>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo display('stock_sale') ?>
                                                <?php echo form_open('Creport/index', array('class' => 'form-inline', 'method' => 'post')) ?>
