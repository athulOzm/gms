                    ...
                    <div class="panel-body"> 
                        <div class="col-sm-10">
                            <form action="<?php echo base_url('Ccustomer/customer_search_item') ?>" class="form-inline" method="post" accept-charset="utf-8">
                                ...
                                <input type="text"   name="customer_name" class=" form-control" placeholder='<?php echo display('customer_name'); ?>' id="customer_name"  onkeyup="customer_autocomplete()"/>
                                <input id="autocomplete_customer_id" class="customer_hidden_value abc" type="hidden" name="customer_id">
                                <button type="submit" class="btn btn-primary"><?php echo display('search') ?></button>
                            </form>
                        </div>	
                        <div class="col-sm-2">
                            <select class="form-control" id="status" name="status" onchange="all_activeInactive(this.value)" data-placeholder="-- select one -- ">
                                <option value=""></option>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h3><?php echo display('manage_customer'); ?></h3>
<!--                            <a href="<?php echo base_url('Ccustomer/customer_downloadpdf') ?>" class="btn btn-warning">Pdf</a> 
                            <a href="<?php echo base_url() . 'Ccustomer/exportCSV'; ?>" class="btn btn-success">ExportCSV </a>-->
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive" id="active_inactiveResults">
                            <!--dataTableExample3-->
                            <table id="" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right"><?php echo display('status'); ?></th>
...
<input type="hidden" id="activeInactiveURL" value="<?php echo base_url('Ccustomer/all_activeInactive_data/'); ?>">
<!-- Manage Customer End -->
