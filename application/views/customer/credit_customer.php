                        ...
                        <div class="table-responsive">
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right"><?php echo display('action') ?>
                                            <?php echo form_open('Ccustomer/credit_customer', array('class' => 'form-inline', 'method' => 'post')) ?>
                                ...
                                <tbody>
                                    <?php
                                    if ($customers_list) {
                                        ?><?php foreach ($customers_list as $custlist) { ?>
                                            <tr>
                                                ...
                                                <td class="text-right"> <?php echo (($position == 0) ? "$currency " . number_format($custlist['customer_balance'], 2, '.', ',') : number_format($custlist['customer_balance'], 2, '.', ',') . " $currency"); ?></td>

        <?php if ($this->permission1->check_label('credit_customer')->update()->access() || $this->permission1->check_label('credit_customer')->delete()->access()) { ?>
                                                    <td>
                                            <center>
                                                    <?php if ($this->permission1->check_label('credit_customer')->update()->access()) { ?>
                                                ...
                                                <?php if ($this->permission1->check_label('credit_customer')->delete()->access()) { ?>
