...
//                                                    echo date('d-M-Y', strtotime($single['date']));
                                                ...
                                                <td>
                                                    <a href="<?php
                                                    if ($single['is_return'] == 0) {
                                                        echo base_url('Cjob/show_job_invoice/' . $single['job_id']);
                                                    } elseif ($single['is_return'] == 1) {
                                                        echo base_url('Cretrun_m/invoice_inserted_data/' . $single['invoice_no']);
                                                    }
                                                    ?>">
                                                           <?php
