            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="currency" id="currency" tabindex="5">
                                    <?php foreach ($currency_list as $clist) { ?>
                                        <option value="<?php echo $clist->icon ?>" <?php
                                        if ($currency == $clist->icon) {
                                            echo "selected";
                                        }
                        ...
                        <div class="form-group row">
                            <label for="labour_cost" class="col-sm-3 col-form-label"><?php echo display('labour_cost') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="labour_cost" id="labour_cost" type="text" placeholder="<?php echo display('labour_cost'); ?>" value="{labour_cost}" tabindex="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="date_format" class="col-sm-3 col-form-label"><?php echo display('date_format') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <select class="form-control select2" name ="date_format" id="date_format" data-placeholder="-- select one --">
                                    <option value=""></option>
                                    <option value="1" <?php
                                    if ($date_format == 1) {
                                        echo 'selected';
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="footer_text" id="footer_text" type="text" placeholder="Foter Text" value="{footer_text}" tabindex="8">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <?php
                                echo form_dropdown('language', $language, '', 'class="form-control" id="language" tabindex="9"');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="captcha" id="captcha" tabindex="11">
                                    <option value=""><?php echo display('select_one') ?></option>
                                    <option value="0" <?php
                                    if ($captcha == 0) {
                                        echo "selected";
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="site_key" id="site_key" type="text" placeholder="<?php echo display('site_key') ?> " value="{site_key}" tabindex="12">
                            </div>
                        </div>    
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="secret_key" id="secret_key" type="text" placeholder="<?php echo display('secret_key') ?>" value="{secret_key}" tabindex="13">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="discount_type" id="discount_type" tabindex="14">
                                    <option value=""><?php echo display('select_one') ?></option>
                                    <option value="1" <?php
                                    if ($discount_type == 1) {
                                        echo "selected";
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-customer" class="btn btn-success btn-large" name="add-customer" value="<?php echo display('save_changes') ?>" tabindex="15"/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
