...
<div class="content-wrapper">
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <a href="<?php echo base_url('Cunit/unit_downloadpdf') ?>" class="btn btn-warning text-white">Pdf</a> 
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <center>
                                        ...
                                        <?php if ($this->permission1->method('manage_unit', 'delete')->access()) { ?>
                                            <a href="javascript:void(0)" class="DeleteUnit btn btn-danger btn-sm" name="{unit_id}" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            <?php } ?>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
    ...
    <input type="hidden" id="unitDeleteUrl" value="<?php echo base_url('Cunit/unit_delete'); ?>">
</div>
