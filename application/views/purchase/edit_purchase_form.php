                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right"><?php echo display('qty') ?> <i class="text-danger">*</i></th>
                                        <th class="text-right"><?php echo display('rate') ?><i class="text-danger">*</i></th>
