                            ...
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class=""><?php echo display('service_type') ?></th>
                                        <th class=""><?php echo display('service_category') ?></th>
                                        <th class=""><?php echo display('service_name') ?></th>
                                        <th class=""><?php echo display('service_rate') ?></th>
                                        <th class=""><?php echo display('standard_timing') ?></th>
                                    ...
                                    if ($service_list) {
                                        ...
                                        foreach ($service_list as $services) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $services['service_type_name']; ?></td>
                                                <td><?php echo $services['service_category_name']; ?></td>
                                                <td><?php echo $services['service_name']; ?></td>
                                                <td><?php echo $services['service_rate']; ?></td>
                                                <td><?php echo $services['standard_timing']; ?></td>
