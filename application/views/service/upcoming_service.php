...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('upcoming_service') ?></small>
            <ol class="breadcrumb">
                <li><a href=""><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('service') ?></a></li>
                <li class="active"><?php echo display('upcoming_service') ?></li>
            </ol>
        </div>
    </section>
    <?php
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <?php echo display('upcoming_service'); ?>
                        </div>
                    </div>
...
//                                dd($upcoming_service);
                                if ($upcoming_service) {
                                    $sl = 0;
                                    foreach ($upcoming_service as $upcoming) {
                                        $sl++;
                                        ?>
                                        <tr>
                                            <td><?php echo $sl; ?></td>
