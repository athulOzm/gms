...
<!--                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left"><nobr></nobr></td>
                                    <td colspan="4"><nobr><span align="right"><?php echo display('in_word').' : ' ?>{am_inword}</span> <?php echo display('taka_only')?></td><td align="right"><strong><?php echo display('grand_total')?></strong></nobr></td>
                                    <td align="right"><nobr>
                                        <strong>
