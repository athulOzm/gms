...
<div class="content-wrapper">
    ...
    <section class="content">
       ...
       <?php if($this->permission1->check_label('manage_invoice')->read()->access()){ ?>
                    ...
                    <?php }?>
         <?php if($this->permission1->check_label('pos_invoice')->read()->access()){ ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <i class="fa fa-angle-double-down"></i>
                                 ...
                                 <tr>
                                    <td style="text-align:right;" colspan="7"><b><?php echo display('shipping_cost') ?>:</b></td>
                                    <td class="text-right">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td colspan="7"  style="text-align:right;"><b><?php echo display('previous'); ?>:</b></td>
                                    <td class="text-right">
                                        <input type="text" id="previous" class="form-control text-right" name="previous" value="0.00" readonly="readonly" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="7"  style="text-align:right;"><b><?php echo display('net_total'); ?>:</b></td>
                                    <td class="text-right">
