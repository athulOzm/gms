...
////start  Supplier return form data
    public function supplier_return_data($purchase_id) {
        ...
        $CI->load->model('Web_settings');
//        $purchase_supplier_info = $CI->Returnse->purchase_supplier_info($purchase_id);
...
//                $invoice_detail[$k]['final_date'] = $CI->occational->dateConvert($invoice_detail[$k]['date_return']);
                $invoice_detail[$k]['final_date'] = $CI->occational->dateConvertMyformat($invoice_detail[$k]['date_return']);
...
//                $return_detail[$k]['final_date'] = $CI->occational->dateConvert($return_detail[$k]['date_return']);
                $return_detail[$k]['final_date'] = $CI->occational->dateConvertMyformat($return_detail[$k]['date_return']);
