...
////    ============= its for purchase_supplier_info =============
//    public function purchase_supplier_info($purchase_id) {
//        $this->db->select('*');
...
//    ========= its for get_supplier_chalan ===========
    public function get_supplier_chalan($supplier_id) {
...
//    ============== its  for get_return_info ============
    public function get_return_info($purchase_id) {
        $query = $this->db->select('*')
