...
class Service extends CI_Model {
    ...
    public function service_list() {
        ...
        $this->db->join('service_type b', 'b.service_type_id = a.service_type_id');
        $this->db->join('service_category c', 'c.service_category_id = a.service_category_id');
...
//===== its for owner_upcoming_service ===============
    public function upcoming_service($current_date) {
        $this->db->select('a.*, a.id as reminder_id, b.customer_name, c.vehicle_registration, d.job_type_name');
        ...
        $this->db->where('a.occurrence_date >=', $current_date);
        $this->db->where('a.status', 0);
        $this->db->order_by('a.id', 'desc');
        $query = $this->db->get();
        return $query->result();

//                SELECT * FROM service_reminder_tbl WHERE occurrence_date >= '2019-08-19' AND status = 0
    }

//===== its for customer_upcoming_service ===============
    public function owner_upcoming_service($user_id, $current_date) {
        $this->db->select('a.*,  a.id as reminder_id, b.customer_name, c.vehicle_registration, d.job_type_name');
        $this->db->from('service_reminder_tbl a');
        $this->db->join('customer_information b', 'b.customer_id = a.customer_id');
        $this->db->join('vehicle_information c', 'c.vehicle_id = a.registration_no');
...
//===== its for overdue_service ===============
    public function overdue_service($current_date) {
        $this->db->select('a.*,  a.id as reminder_id, b.customer_name, c.vehicle_registration, d.job_type_name');
        $this->db->from('service_reminder_tbl a');
        $this->db->join('customer_information b', 'b.customer_id = a.customer_id');
        $this->db->join('vehicle_information c', 'c.vehicle_id = a.registration_no');
...
//    ============ its for owner_overdue_service =============
    public function owner_overdue_service($user_id, $current_date) {
        $this->db->select('a.*,  a.id as reminder_id , b.customer_name, c.vehicle_registration, d.job_type_name');
        $this->db->from('service_reminder_tbl a');
        $this->db->join('customer_information b', 'b.customer_id = a.customer_id');
        $this->db->join('vehicle_information c', 'c.vehicle_id = a.registration_no');
...
//    ============ its for owner completed service =============
    public function owner_completed_service($user_id) {
        $this->db->select('a.*,  a.id as reminder_id , b.customer_name, c.vehicle_registration, d.job_type_name');
        $this->db->from('service_reminder_tbl a');
        $this->db->join('customer_information b', 'b.customer_id = a.customer_id');
        $this->db->join('vehicle_information c', 'c.vehicle_id = a.registration_no');
